    ...
    <div id="page-site-header">
        <div class="wrapper">
            <header class="page-header animated animatedFadeInUp">
                <h1 class="page-title"><?php esc_html_e( 'Oops! That page can&rsquo;t be found.', 'magic-blog' ); ?></h1>
            </header>
            <?php  
        ...
        <div id="primary" class="content-area">
            <main id="main" class="site-main" role="main">
                <div class="single-post-wrapper animated animatedFadeInUp">
					...
					<p><?php esc_html_e( 'It looks like nothing was found at this location. Maybe try a search?', 'magic-blog' ); ?></p>
