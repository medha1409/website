...
class wp_bootstrap_mobile_navwalker extends Walker_Nav_Menu {
    ...
    function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        if (strcasecmp($item->attr_title, 'divider') == 0 && $depth === 1) {
            ...
            $class_names = join( ' ', apply_filters( 'mythos_nav_menu_css_class', array_filter( $classes ), $item, $args ) );
            ...
            $id = apply_filters( 'mythos_nav_menu_item_id', 'menu-item-'. $item->ID, $item, $args );
            ...
            $atts = apply_filters( 'mythos_nav_menu_link_attributes', $atts, $item, $args );
            ...
            $item_output .= $args->link_before . apply_filters( 'mythos_the_title', $item->title, $item->ID ) . $args->link_after;
            $item_output .=  '</a>';
            ...
            $output .= apply_filters( 'mythos_walker_nav_menu_start_el', $item_output, $item, $depth, $args );
        }
    }
