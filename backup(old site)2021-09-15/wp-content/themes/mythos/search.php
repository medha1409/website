                ...
                <div class="row">
                    <?php if ( have_posts() ){
                        ...
                        <?php endwhile;
                            ...
                            <div class="col-md-12">
                                <div class="error-log">
                                    <h2 class="search-error-title"><?php esc_html_e( 'Nothing Found', 'mythos' ); ?></h2>
                                    <p class="search-error-text"><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with different keywords.', 'mythos' ); ?></p>
                                    <?php get_search_form();?>
                                </div>
                            </div>
                        <?php } ?>
